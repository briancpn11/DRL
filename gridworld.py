...
class GridWorldEnv():
    ...
    def __init__(self, gridsize = 7, startState = '00', terminalStates = ['44'], ditches = ['32', '42', '52', '62', '33', '34', '35', '45', '55', '54'],  
                 ditchPenalty = -40, turnPenalty = -1, winReward = 100, mode = 'prod'):
        ...
        if self.mode == 'debug':
            print("State Space", self.startspace)
    ...
    def get_totalReward(self):
        return self.totalAccumulatedReward
    ...
    def step(self, action):
        ...
        self.totalAccumulatedReward += reward
        self.totalTurns += 1
        if self.mode == 'debug':
            print("Obs: {}, Reward: {}, Done: {}, TotalTurns: {}, TotalRewards: {}".format(obs, reward, done, self.totalTurns, self.totalAccumulatedReward))
