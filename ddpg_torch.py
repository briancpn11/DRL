...
Original file is located at
    https://colab.research.google.com/drive/1b3mZuyyAZDsbOgRDJakQZs_o-DA6gWdV
"""
...
class CriticNetwork(nn.Module):
  def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions, name, chkpt_dir = 'tmp\\td3'):
...
class ActorNetwork(nn.Module):
  def __init__(self, alpha, input_dims, fc1_dims, fc2_dims, n_actions, name, ckhpt_dir = 'tmp\\td3'):
...
if __name__ == "__main__":
  ...
  agent = Agent(alpha = 0.001, beta = 0.001, input_dims=env.observation_space.shape, tau = 0.005, env = env, batch_size = 100, 
                layer1_size = 400, layer2_size = 300, n_actions = env.action_space.shape[0])
